...
# Agradecimientos
## A Chat gepete
Gracias por acompañarnos durante todo este semestre.
Fuiste clave, una herramienta fiel en cada desvelo, en cada duda y en cada explicación salvadora.
Gracias por todo. :")

## A DeepSeek
Porque sin esa joyita, varios exámenes habrían sido puro sufrimiento.
Gracias por las horas de estudio compartidas, no solo en Teoría de la Computación,
...
## A Dross
Por no abandonar jamás esas madrugadas de proyectos donde solo quedábamos tú, yo y el crujir del teclado.

## A los maestros de la India en YouTube
Porque explican lo que otros complican.
Sin ellos, más de uno hubiera desertado.

### y por ultimo y no menos importante...
## A la profe Merly 
Gracias por ser tan linda y no torturarnos :"V
